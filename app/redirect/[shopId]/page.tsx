...
export default function RedirectPage() {
  ...
  if (!isClient || !merchant) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-violet-600 to-violet-700">
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 relative overflow-hidden">
      ...
      {hasBackground ? (
        ...
        <div className="absolute inset-0 bg-gradient-to-br from-violet-600 to-violet-700"></div>
      )}
            ...
            {!isWhatsAppMode && (
              <p className={`text-sm ${strategyInfo.text_color} text-center leading-relaxed`}>
                {strategyInfo.message.split('**').map((part, index) =>
                  index % 2 === 1 ? (
                    <span key={index} className="font-bold text-violet-600 underline decoration-2 underline-offset-2">
                      {part}
                    </span>
                  ) : (
              ...
              {!hasClickedSocial ? (
                ...
                <div className="text-center space-y-4">
                  <div className="relative">
                    ...
                    <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
                      <div className="bg-white/90 rounded-full w-14 h-14 flex items-center justify-center shadow-lg border-2 border-violet-200">
                        <span className="text-2xl font-bold text-violet-600">{countdown}</span>
                      </div>
                    </div>
                  </div>
                  <p className="text-sm text-gray-500">
                ...
                <div className="space-y-3">
                  <Button
                    ...
                    className="w-full bg-gradient-to-r from-violet-500 to-violet-600 hover:from-violet-600 hover:to-violet-700 text-white py-4 rounded-xl font-semibold transition-all shadow-lg hover:shadow-xl flex items-center justify-center gap-2 text-lg"
                  >
