          ...
          <div className="grid grid-cols-2 gap-3">
            {LANGUAGES.map((lang) => (
              <button
                ...
                className="flex items-center gap-3 p-4 rounded-xl border-2 border-gray-200 hover:border-violet-500 hover:bg-violet-50 transition-all duration-200 group"
              >
