...
export default function RatingPage() {
  ...
  if (!merchant) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-violet-600 to-violet-700 p-4">
          ...
          {!rating ? (
            ...
            <div className="space-y-5">
                  ...
                  <div className="relative">
                    <input
                      ...
                      className={`w-full p-4 pl-11 border-2 ${
                        emailError ? 'border-red-300 focus:ring-red-500' : 'border-gray-200 focus:ring-violet-500'
              ...
              <Button
                ...
                disabled={loading}
                className="w-full bg-violet-600 hover:bg-violet-700 text-white py-3 rounded-xl font-semibold transition-all shadow-lg hover:shadow-xl"
              >
