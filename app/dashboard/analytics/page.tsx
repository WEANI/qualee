      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          <Card className="p-6 border-l-4 border-l-pink-500">
            ...
            <p className={`text-xs mt-2 ${reviewsTrend.isPositive ? 'text-pink-600' : 'text-red-600'}`}>
          ...
          <Card className="p-6 border-l-4 border-l-pink-500">
            ...
            <p className={`text-xs mt-2 ${positiveTrend.isPositive ? 'text-pink-600' : 'text-red-600'}`}>
          ...
          <Card className="p-6">
            ...
            <div className="space-y-3">
              {[5, 4, 3, 2, 1].map((rating) => {
                ...
                const barColor = rating >= 4 ? 'bg-pink-500' : rating === 3 ? 'bg-amber-500' : 'bg-red-500';
                return (
