...
export default function FeedbackPage() {
  ...
  const filterButtons = [
    { key: 'all' as const, label: 'Tous', count: feedback.length, icon: MessageSquare, activeClass: 'bg-violet-600 text-white border-violet-600', hoverBorder: 'border-violet-400' },
    { key: 'positive' as const, label: 'Positifs', count: feedback.filter(f => f.is_positive).length, icon: ThumbsUp, activeClass: 'bg-indigo-600 text-white border-indigo-600', hoverBorder: 'border-indigo-400' },
                  ...
                  <div className="flex items-center gap-3">
                    <div
                      className={`w-10 h-10 rounded-lg flex items-center justify-center flex-shrink-0 ${
                        f.is_positive ? 'bg-indigo-50' : 'bg-red-50'
                      }`}
                    >
                      {f.is_positive ? (
          ...
          <div className="group relative border border-gray-200 rounded-xl overflow-hidden transition-all duration-300 hover:border-gray-300 hover:shadow-md bg-white">
            ...
            <div className="p-8 sm:p-12">
              <div className="text-center">
                <div className="w-16 h-16 rounded-xl bg-violet-50 flex items-center justify-center mx-auto mb-4">
