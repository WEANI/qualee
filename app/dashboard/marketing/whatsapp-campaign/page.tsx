      ...
      <div className="space-y-8">
            ...
            {savedCampaigns.length === 0 ? (
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                {savedCampaigns
                  ...
                  <div
                    key={campaign.id}
                    className={`border rounded-xl p-4 hover:border-pink-500 transition-colors cursor-pointer ${
                      currentCampaignId === campaign.id ? 'border-pink-500 bg-pink-50' : 'border-slate-200'
                    }`}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                  ...
                  >
                    ...
                    <div className="mb-4">
                      ...
                      {card.mediaUrl ? (
                        ...
                        <div
                          ...
                          className="w-full h-48 border-2 border-dashed border-slate-300 rounded-lg flex flex-col items-center justify-center cursor-pointer hover:border-pink-500 hover:bg-pink-50/50 transition-colors"
                        >
                    ...
                    <div className="mb-4">
                      ...
                      <textarea
                        ...
                        rows={2}
                        className="w-full px-3 py-2 border border-slate-200 rounded-lg focus:ring-2 focus:ring-pink-500 focus:border-transparent resize-none text-sm"
                      />
                    </div>
                    ...
                    <div className="mb-4">
                      ...
                      <input
                        ...
                        className="w-full px-3 py-2 border border-slate-200 rounded-lg focus:ring-2 focus:ring-pink-500 focus:border-transparent text-sm"
                      />
                    </div>
          ...
          <div className="space-y-6">
                    ...
                    {cards.map((card, index) => (
                      ...
                      >
                        ...
                        <div className="p-3">
                          ...
                          <button className="w-full py-1.5 bg-slate-100 rounded text-xs font-medium text-pink-600 flex items-center justify-center gap-1">
            ...
            {/* Next Step Info */}
            <div className="bg-gradient-to-br from-pink-50 to-pink-50 rounded-2xl border border-pink-200 p-6">
              <h3 className="text-lg font-semibold text-pink-900 mb-2">{t('marketing.whatsappCampaign.nextStep')}</h3>
              <p className="text-sm text-pink-700 mb-4">{t('marketing.whatsappCampaign.nextStepDescription')}</p>
              <Button
